...
file_path = 'D:\\DAV_LABs\\DAV Project\\PreProcessing_M_M_M_V_C_C\\social protection and labor\\31297f3f-115b-4e5a-b80c-e4218ffbe53e_Data.csv'  # Adjust to your file path
try:
    ...
    print("Files in directory:", os.listdir('d:\\DAV_LABs\\DAV Project\\social_protection\\'))
    raise
...
# Step 3: Convert year columns to numeric, handling missing values
df[year_cols] = df[year_cols].replace(['..', ''], np.nan)
df[year_cols] = df[year_cols].apply(pd.to_numeric, errors='coerce')

# Step 4: Select the reference indicator for covariance and correlation
reference_indicator = 'SL.UEM.TOTL.ZS'  # Unemployment, total (% of total labor force) (modeled ILO estimate)
...
# Step 5: Function to compute statistics for a row
...
# Step 6: Process each row and collect results
stats_list = []
...
output_file = 'social_protection_stats.csv'
try:
...
# Step 9: Display the first few rows of the results

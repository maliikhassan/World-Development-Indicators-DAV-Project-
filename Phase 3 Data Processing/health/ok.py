...
file_path = 'D:\\DAV_LABs\\DAV Project\\PreProcessing_M_M_M_V_C_C\\health\\4f2f6b82-aa5d-429f-80d4-564ae648423d_Data.csv'
try:
    ...
    print("Files in directory:", os.listdir('D:\\DAV_LABs\\DAV Project\\PreProcessing_M_M_M_V_C_C\\health\\'))
    raise
...
reference_indicator = 'SH.UHC.SRVS.CV.XD'  # UHC service coverage index, which exists in this dataset

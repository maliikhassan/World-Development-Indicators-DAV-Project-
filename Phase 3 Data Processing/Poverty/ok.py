...
file_path = 'D:\\DAV_LABs\\DAV Project\\PreProcessing_M_M_M_V_C_C\\Poverty\\70e8aabb-b542-4bcc-b874-fccfdff1114b_Data.csv'
try:
    ...
    print("Files in directory:", os.listdir('D:\\DAV_LABs\\DAV Project\\PreProcessing_M_M_M_V_C_C\\Poverty\\'))
    raise
...
non_numeric_cols = ['Unnamed: 0', 'Country Name', 'Country Code', 'Series Name', 'Series Code']
...
reference_indicator = 'SI.POV.GINI'  # Gini index, which exists in this dataset
